				...
				<div class="contact-agileinfo">
					...
					<div class="contact-right wthree">
						<div class="col-xs-7 contact-text w3-agileits">
							<h4>GET IN TOUCH :</h4>
							<p>
								<i class="fa fa-map-marker"></i> Al Makkah Shopping Store.</p>
							<p>
								<i class="fa fa-phone"></i> Telephone : 051-4265514</p>
							<p>
								
							<p>
								<i class="fa fa-envelope-o"></i> Email :
								<a href="mailto:example@mail.com">admin-almakkah@gmail.com</a>
							</p>
						</div>
