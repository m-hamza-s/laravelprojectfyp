                            ...
                            <div class="item-info-product ">
                                ...
                                <form action="/Cart/add"method="post">
                                    ...
                                    <input type="hidden" name="category" value="oil" />
                                            ...
                                            @auth
                                            <a href="javascript:void(0)" class="link-product-add-cart" onclick="addwishlist({{$oil->id}})" style="width: 50px; float:right; margin-top:-9px;">
                                                @if($oil->wishlist)
                                                <i class="fa fa-heart icon-{{$oil->id}}"></i>
                                                @else
                                                <i class="fa fa-heart-o icon-{{$oil->id}}"></i>
                                                @endif
                                            </a>
                                            @endauth
