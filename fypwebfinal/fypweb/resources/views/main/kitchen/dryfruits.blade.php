                            ...
                            <div class="item-info-product ">
                                ...
                                <form action="/Cart/add"method="post">
                                    ...
                                    <input type="hidden" name="category" value="dry" />
                                            ...
                                            @auth
                                            <a href="javascript:void(0)" class="link-product-add-cart" onclick="addwishlist({{$dry->id}})" style="width: 50px; float:right; margin-top:-9px;" >
                                                @if($dry->wishlist)
                                                <i class="fa fa-heart icon-{{$dry->id}}"></i>
                                                @else
                                                <i class="fa fa-heart-o icon-{{$dry->id}}"></i>
                                                @endif
                                            </a>
                                            @endauth
